...
async def create_embeddings(request: EmbeddingRequest):
    ...
    Uses the currently loaded model to extract normalized embedding vectors
    via RKLLM_INFER_GET_LAST_HIDDEN_LAYER. Supports batch processing.
    ...
    """
    try:
        from api.adapters import openai_embedding_to_internal, internal_to_openai_embedding
